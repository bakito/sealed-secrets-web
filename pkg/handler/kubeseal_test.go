...
var _ = Describe("Handler ", func() {
	Context("KubeSeal", func() {
		...
		It("should return 422 if .data contains invalid base64 (json)", func() {
			...
			Ω(recorder.Body.String()).Should(ContainSubstring("Data must be uniformly base64-encoded or in plain text. Use .data for encoded or .stringData for plaintext"))
		})
